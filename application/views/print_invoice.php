	...
	<table border="0" style="border-collapse: collapse; width: 100%; height: auto;">
		...
		<tr>
			<td width="100%">
				...
				<span class="left" style="text-align: left;"><?php echo "Served By:"; ?>&nbsp; : <?php echo $staff_name; ?></span>
			</td>
		</tr>   
    </table>
...
-->
    ...
    <div id="bkpos_wrp">
    	<a href="<?=base_url()?>pos" style="width:100%; display:block; font-size:12px; text-decoration: none; text-align:center; color:#FFF; background-color:#2ebc60; border:0px solid #007FFF; padding: 10px 1px; margin: 5px auto 10px auto; font-weight:bold;"><?php echo $lang_back_to_pos; ?></a>
    </div>
    
    <div id="bkpos_wrp">
    	<button type="button" onClick="window.print()
		;return false;" style="width:101%;
		cursor:pointer;
		font-size:12px; 
		...
		padding: 10px 0px;
		font-weight:bold;">
		<?php echo $lang_print_small_receipt; ?></button>
    </div>
