...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <select name="supplier" class="form-control" required>
        ...
        <?php foreach($suppliers as $supplier): ?>
            <option value="<?php echo $supplier->id; ?>" <?php if(isset($data['supplier_id']) && $data['supplier_id'] == $supplier->id) echo 'selected'; ?>>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="file" name="uploadFile" class="form-control" accept="image/jpg, image/png" />
                            </div>
                        </div>
                    </div>
