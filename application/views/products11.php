...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <h4 class="text-primary font-weight-bold mb-2">Total Stock Value</h4>
    <h2 class="text-success font-weight-bold">
        KSH.<?php echo isset($total_stock_value) ? number_format($total_stock_value, 2) : '0.00'; ?>
    </h2>
</div>
<div class="card shadow-sm border-0 bg-light p-3 text-center">
    <h4 class="text-primary font-weight-bold mb-2">Expected Sales plus profit</h4>
    <h2 class="text-success font-weight-bold">
        KSH.<?php echo isset($total_salesprofit) ? number_format($total_salesprofit, 2) : '0.00'; ?>
    </h2>
</div>
					</div>
								...
								<?php
                                    if (count($results) > 0) {
										...
										<a class="fancybox" rel="group" href="<?php echo $large_file_path; ?>" style="text-decoration: none;" title="<?php echo $code; ?>">
											<i class="icono-image" style="color: #2ebc60; height: 30px;"></i>
										</a>
