	...
	<table border="0" style="border-collapse: collapse; font-family: arial; font-size: 11px;" width="100%" height="auto">
		<tr>
			<td width="100%" height="auto" align="center">
				<h1 style="font-size: 40px; color: #2ebc60;"><?php echo $lang_purchase_order; ?></h1>
			</td>
		</tr>
	</table>
	<table border="0" style="border-collapse: collapse; font-family: arial; font-size: 13px; margin-top: 10px; border-bottom: 1px solid #656563; padding-bottom: 10px;" width="100%" height="auto">
		<tr>
			...
			<td width="50%" height="auto" align="right" valign="top">
				<table border="0" style="border-collapse: collapse;" width="100%" height="auto">
					<tr>
						<td width="60%" height="20px" align="right" style="font-size: 15px; color: #2ebc60;"><?php echo $lang_purchase_order_number; ?>&nbsp;&nbsp;</td>
						<td width="40%" style="font-size: 15px; color: #2ebc60;">: &nbsp;<?php echo $po_numb; ?></td>
					</tr>
					<tr>
						<td width="60%" height="20px" align="right" style="font-size: 15px; color: #2ebc60;"><?php echo $lang_created_date; ?>&nbsp;&nbsp;</td>
						<td width="40%" style="font-size: 15px; color: #2ebc60;">: &nbsp;<?php echo $po_date; ?></td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<table border="0" style="border-collapse: collapse; font-family: arial; font-size: 11px; margin-top: 0px;" width="100%" height="auto">
		<tr>
			<td width="50%" height="auto" align="left">
				<h1 style="font-size: 15px; color: #2ebc60;"><?php echo $lang_ship_to; ?></h1>
			</td>
		</tr>
	</table>
