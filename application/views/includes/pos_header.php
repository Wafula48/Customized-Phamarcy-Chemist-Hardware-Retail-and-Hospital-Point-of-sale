	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand1" href="<?=base_url()?>dashboard">
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="<?=base_url()?>auth/logout"><i class="icono-power" style="color: #2ebc60;"></i> <?php echo $lang_logout; ?></a></li>
						</ul>
					</li>
					<li class="dropdown pull-right">
						<a href="<?=base_url()?>dashboard" style="text-decoration: none; color: #2ebc60;">
							<span style="">
